...
function getAhora12(cantCuotas, monto) {
  ...
  switch (cantCuotas) {
    case '3':
    total = (monto * 15 / 100) + Number(monto) / cantCuotas;

      break;
    case '6':
    total = (monto * 30 / 100) + Number(monto) / cantCuotas;

      break;
    case '12':
    total = (monto * 55 / 100) + Number(monto) / cantCuotas;
...
if (abonar == 1) {
  ...
  alert("El total es: " + cantCuotas + " cuotas de $" + total);
